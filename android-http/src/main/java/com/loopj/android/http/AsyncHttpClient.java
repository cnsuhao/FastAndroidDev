...
public class AsyncHttpClient {
    ...
    private static final long THREAD_TIME_OUT = 90L;
    ...
    protected ExecutorService getDefaultThreadPool() {
       ...
       return new ThreadPoolExecutor(CORE_THREAD_NUMBER,                 //core pool size
                Integer.MAX_VALUE, //maximum pool size
                THREAD_TIME_OUT,               //keep alive time
                TimeUnit.SECONDS,
    ...
    public RequestHandle post(Context context, String url, RequestParams params, ResponseHandlerInterface responseHandler) {
        return post(context, url, paramsToEntity(params, responseHandler), "application/json", responseHandler);
    }
